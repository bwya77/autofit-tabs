...
class AutoFitTabsPlugin extends Plugin {
    ...
    async onload() {
        ...
        this.registerEvent(
            this.app.workspace.on('file-open', () => {
                ...
                if (activeHeader && !this.tabWidthCache.has(this.getHeaderKey(activeHeader))) {
                    requestAnimationFrame(() => this.adjustAllHeaders());
                }
            })
        );
    ...
    applyHeaderStyles(header, width) {
...
module.exports = AutoFitTabsPlugin;